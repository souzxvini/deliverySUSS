...
public class AdminUsersController {
	...
	@GetMapping(value = "user/editarSenha")
	...
	@PostMapping(value = "user/atualizar",consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	...
	@PostMapping("user/atualizarSenha")
	...
	@GetMapping(value = "user/excluir/{id}")
	...
	@GetMapping(value = "user/imagem/{id}")
	@ResponseBody
	...
	@GetMapping(value = "user/editarFoto")
	...
	@PostMapping("user/atualizarFoto")
